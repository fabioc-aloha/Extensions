...
- [.github/instructions/teams-app-patterns.instructions.md] (High, Coordinates, Bidirectional) - "Teams app deployments commonly use enterprise Azure infrastructure"
