...
[![Installs](https://img.shields.io/visual-studio-marketplace/i/fabioc-aloha.cx-secret-guard)](https://marketplace.visualstudio.com/items?itemName=fabioc-aloha.cx-secret-guard)
