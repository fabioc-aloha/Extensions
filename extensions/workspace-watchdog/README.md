...
[![Installs](https://img.shields.io/visual-studio-marketplace/i/fabioc-aloha.cx-workspace-watchdog)](https://marketplace.visualstudio.com/items?itemName=fabioc-aloha.cx-workspace-watchdog)
